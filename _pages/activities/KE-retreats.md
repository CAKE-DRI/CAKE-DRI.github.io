...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="/assets/images/ke_retreats.png" width="90%">
</div>

<br>

CAKE retreats funding brings communities together to enrich the UK’s large-scale computing landscape. By creating space for focused engagement, the programme supports the development of shared concepts, strategic directions, and outputs such as white papers, reports, or journal special issues. 
...
We are committed to fostering a diverse and inclusive environment that reflects the breadth of the CAKE network and the wider UK Digital Research Infrastructure community. We actively encourage applications from all members of the community, regardless of background, discipline, or career stage. We have ambitions for specific targets, including aiming for around 50% of participants to come from non-academic organisations.
...
Awards are made through a transparent and competitive process overseen by the Review Committee (RC). We will issue themed Expression of Interest (EoI) calls targeting strategically important topics within the UK’s Digital Research Infrastructure landscape. Applicants will complete and submit the corresponding EoI which are then sent on to the network’s RC for consideration. There will be review guidance issued to the RC and using this reviewers will score an application out of 100. Following the approach adopted in the ExCALIBUR-ECP collaboration programme, this score will be split across different weighted sections, and then a final recommendation of whether this is worth funding (yes, no and unsure) will be made. Each application will receive at-least four reviews, and then for each call the task leader will run a (virtual) meeting with all reviewers to discuss each application in detail. Final decisions will be made, where feedback and outcomes will be provided to applicants. In order to get timely decisions out we aim for each review process to last no longer than 6 weeks.

To support early career researchers and individuals returning after a career break, we will offer guidance and mentoring during the EoI process, and career stage will be taken into account as part of the review.
 ...
 * Call 2 (Topic): [coming soon]
 * Call 3 (Topic): [coming soon]
...
Funded activities will be monitored by the task lead, with progress reported to the Steering Group. Awardees must provide evidence of expenditure when submitting expense claims through University of Edinburgh finance processes.
...
*Hosting a retreat*
  * community outputs such as white papers, reports, publications, or open-source software where appropriate

*Attending a retreat*
 * a short article summarising key insights and outcomes for the CAKE website
