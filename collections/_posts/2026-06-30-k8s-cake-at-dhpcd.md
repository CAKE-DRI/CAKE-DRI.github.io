---
title: "STFC Kubernetes Workshop - K8s CAKE fellowship"
date: 2026-06-30
full-width: true 
classes: wide
summary-image: /assets/images/kubernetes_cake.png
categories:
  - news
tags:
  - knowledge exchange
...
As with the Cloud Native Special Interest Group and the CAKE Fellowship more broadly, our aim is to make industry-standard tools accessible to new audiences. In this case, Piper and I developed a hands-on introduction to Kubernetes, focusing on both the concepts behind container orchestration and the practical skills needed to begin experimenting with the technology.

The tutorial was, in many ways, a success. We received positive feedback from attendees, encouraged thoughtful discussions around orchestration platforms, and even learned a few things ourselves about Raspberry Pis and network configuration. The audience particularly appreciated taking time to build a shared understanding of Kubernetes concepts before moving into the practical exercises.

Like many first live deliveries of a new tutorial, however, the session was not without challenges. The first half was affected by a combination of configuration issues and the inevitable teething problems that come with running new material for the first time. Fortunately, the break between sessions gave Piper and me an opportunity to identify the issues, fill the gaps, and improve the experience for the afternoon session.

I am very grateful to everyone for their patience and willingness to work through the challenges with us. It was especially rewarding to hear positive responses from participants who were able to experiment with Kubernetes for the first time and begin thinking about how these technologies might apply to their own work. If you couldn’t attend the event and are interested, feel free to check out the [GitHub pages](https://cloud-native-sig.github.io/hpcdays26-pocket-sized-kubernetes/) online. 

Once the tutorial had concluded, I was able to enjoy more of the conference programme. That afternoon I attended the [Build Your Own HPC](https://hpc-days.github.io/Durham-HPC-Days-2026/programme-days-2026/build-your-own-HPC-tuesday-16-30/) workshop, another Raspberry Pi-based session led by Jannette Steyn and Samantha Finnigan. With Kubernetes and Raspberry Pis already fresh in my mind, I particularly appreciated both the content and the delivery style of the workshop. The way The Carpentries approach hands-on learning using Raspberry Pis has given me several ideas that I hope to incorporate into future versions of our own tutorial.
