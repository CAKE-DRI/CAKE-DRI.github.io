---
title: "Rethinking Research at the 2026 Open Science Retreat"
date: 2026-06-08
full-width: true
classes: wide
summary-image: /assets/images/event-images/open-science-retreat/CAT-wise.jpg
categories:
  - news
tags:
  - placements
...
At the beginning of April 2026 a group gathered at The Centre for Alternative Technology in Wales for the [2026 Global Open Science Retreat.](https://open.science-retreat.org/OSR26UK/)
...
The first element of the event (after [the pre-event hackathon organised by UKRN](https://www.ukrn.org/2026/06/15/reflections-from-the-open-science-retreat-2026/)), was an "Unconference Planning Session". An unconference is like a conference, except the activities and subjects are not decided in advance by an organising committee, but instead are decided by the participants at the start of the event. Participants had been submitting ideas for the previous fortnight, and these were now taped up on walls around the auditorium, for folks invited to mill around and discuss, and ultimately choose which topic group to form/join for the next few days. Choosing which group to join is always challenging for me - there's more good ideas than there will ever be time for.

For the next few days, the schedule included time to work within people's chosen topic groups, time for short sessions ("hey I mentioned this thing to someone and they got excited about it, anyone else wanna do an impromptu session on it tomorrow afternoon?"), and some workshops and tours run by CAT (one of my personal highlights was a hike through the history of CAT's wind turbines, culminating with visiting [the community-owned Nordtank turbine](https://bdcr.org.uk/generators/nordtank/)), and a morning of presentations on the final day showing the creative ways participants had engaged with topics they were passionate about.


I’ll resist summarising all the presentations (see some links at the end). I’ll pick just two examples:
The “Systems Thinking” group presented [their work on mapping the open science system](https://codeberg.org/academia-systems-thinking/OSR2026), to “better understand how the different components and interconnections are supporting the goal, what blockers are not being well managed, and what leverage points can be targeted for optimisation”. 

<br>

<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="/assets/images/event-images/open-science-retreat/map-latest.png" style="max-width: 75%; height: auto;">
</div>

<div style="text-align: center; font-size: 0.8em; font-style: italic; margin-top: 0.3em;">
    Screenshot of the Systems Thinking map. Source: [https://codeberg.org/academia-systems-thinking/OSR2026](https://codeberg.org/academia-systems-thinking/OSR2026) (CC-BY-4.0)
</div>

<br>

The “Stories” group, meanwhile, made [a map of “Open-topia”](https://dstansby.codeberg.page/open-topia-map/):
...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="/assets/images/event-images/open-science-retreat/opentopia.png" style="max-width: 75%; height: auto;">
</div>

<div style="text-align: center; font-size: 0.8em; font-style: italic; margin-top: 0.3em;">
    A screenshot from the Open-topia website, showing the central hill with an Open-topia banner. Source: [https://dstansby.codeberg.page/open-topia-map/](https://dstansby.codeberg.page/open-topia-map/)
</div>
...
To see some of the things people made at the 2026 Global Open Science Retreat, see [our collection on Research Equals](https://doi.org/10.53962/vwam-tx4m). To read more about Open Science Retreats visit [https://open.science-retreat.org/](https://open.science-retreat.org/).

The event was co-organised by the [Digital Research Academy](https://digital-research.academy/), [UKRN](https://www.ukrn.org/), and [OLS](https://we-are-ols.org/). Thank you to [Research Equals](https://www.researchequals.com/), [Society of Research Software Engineering](https://society-rse.org/), [COS](https://www.cos.io/), [SSI](https://www.software.ac.uk/), [UKRN](https://www.ukrn.org/), and [CAKE](https://www.cake.ac.uk/) for financial support.
